    ...
    <Sheet>
      <div className="flex items-center justify-center">
        <SheetTrigger asChild>
          <Menu size={28} className="block sm:hidden animate-in fade-in duration-300" />
        </SheetTrigger>
      </div>
      ...
      >
        ...
        <div className="absolute right-6 top-6 z-50">
          <SheetClose className="rounded-full p-2 hover:bg-gray-100/10">
            <X 
              size={28} 
              className="text-custom-silver animate-in fade-in duration-300" 
            />
          </SheetClose>
        </div>
        ...
        <div className="relative flex h-full w-full flex-col items-center justify-between px-6 py-[10vh]">
          ...
          <div className="z-20 flex w-full flex-col gap-4">
            ...
            <Link href="dashboard/admin">
              <Button
                className="w-full animate-in slide-in-from-right delay-150 duration-300 bg-custom-black hover:bg-custom-black/80"
